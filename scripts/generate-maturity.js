...
datasets.forEach(ds => {
  ...
  results.push({
    ...
    tier: full.tier,
    components: {
      'Catalog Basics': { score: basics.score, max: basics.max, details: basics.details },
      'Data Steward': { score: steward.score, max: steward.max, details: steward.details },
      'Web Service URL': { score: webService.score, max: webService.max, details: webService.details },
      'Data Standard': { score: dataStandard.score, max: dataStandard.max, details: dataStandard.details },
      'Development Stage': { score: stage.score, max: stage.max, details: stage.details },
      'Blockers & Improvements': { score: issues.score, max: issues.max, details: issues.details },
      'Service Metadata': { score: serviceMetadata.score, max: serviceMetadata.max, details: serviceMetadata.details },
      'Service Capabilities': { score: serviceCapabilities.score, max: serviceCapabilities.max, details: serviceCapabilities.details },
      'Attribute Null Health': { score: nullHealth.score, max: nullHealth.max, details: nullHealth.details },
      'Freshness Confidence': { score: freshnessConfidence.score, max: freshnessConfidence.max, details: freshnessConfidence.details },
    },
  });
});
